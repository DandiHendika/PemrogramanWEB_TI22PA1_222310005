...
unset($__errorArgs, $__bag); ?>" id="name"
                           name="name" placeholder="Your name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email"
                           name="email" placeholder="name@example.com" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center">Sudah memiliki akun? <a href="<?php echo e(route('login.form')); ?>" class="login-link">Login di sini</a></p>
        </div>
    </div>
</div>
<style>
...
<?php /**PATH C:\xampp\htdocs\tugas6\resources\views/tugas8/auth/register.blade.php ENDPATH**/ ?>